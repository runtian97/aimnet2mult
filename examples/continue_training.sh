...
FIDELITY_0_DATASET="${SCRIPT_DIR}/output/subsets/fidelity_0.h5"
FIDELITY_1_DATASET="${SCRIPT_DIR}/output/subsets/fidelity_1.h5"
FIDELITY_2_DATASET="${SCRIPT_DIR}/output/subsets/fidelity_2.h5"
FIDELITY_0_WEIGHT=1.0
FIDELITY_1_WEIGHT=1.0
FIDELITY_2_WEIGHT=1.0
SAE_FID0="${SCRIPT_DIR}/output/subsets/sae_fid0.yaml"
SAE_FID1="${SCRIPT_DIR}/output/subsets/sae_fid1.yaml"
SAE_FID2="${SCRIPT_DIR}/output/subsets/sae_fid2.yaml"
